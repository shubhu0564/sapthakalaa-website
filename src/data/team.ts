...
export const teamMembers: TeamMember[] = [
  {
    ...
    bio: "Visionary architect with 25+ years of experience in environmental design and urban planning. Founded sapthkalaa to bridge traditional wisdom with contemporary design practices.",
    image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=500&fit=crop",
    expertise: ["Urban Planning", "Sustainable Design", "Heritage Conservation", "Landscape Architecture"],
    email: "omkar@sapthkalaa.com",
  },
  {
    id: "team-02",
    name: "Priya Desai",
